  ...
  return (
    <View className="flex-1 bg-background">
      <View className="bg-primary pt-14 pb-8 px-6 rounded-b-3xl">
        ...
        <Text className="text-white text-base mt-1">Panel Punto Aliado</Text>
      ...
      <View className="flex-1 px-6 pt-8 items-center justify-center">
        ...
        <Text className="text-gray-500 text-sm text-center">
          Autenticado como Punto Aliado. Los flujos de depósito y recogida se construirán en la Fase 3.
        </Text>
      </View>
      <TouchableOpacity
